    ...
    public static class Mapping
    {
        ...
        public static MapperConfiguration CreateConfiguration()
        {
           ...
           ;
            ...
            cfg.CreateMap<CompetitionEntryEntity, ImageSalonEntryDto>()
                .ForMember(dto => dto.JudgeDate, x => x.MapFrom(ent => ent.Section.SalonYear.JudgeDate))
                .ForMember(dto => dto.SalonName, x => x.MapFrom(ent => ent.Section.SalonYear.Name))
                .ForMember(dto => dto.SectionName, x => x.MapFrom(ent => ent.Section.SectionType.Name))
                .ForMember(dto => dto.IsAwarded, x => x.MapFrom(ent => ent.IsAwarded))
                .ForMember(dto => dto.AwardDetails, x => x.MapFrom(ent => ent.AwardDetails))
                .ForMember(dto => dto.IsAccepted, x => x.MapFrom(ent => ent.IsAccepted))
                .ForMember(dto => dto.Score, x => x.MapFrom(ent => ent.Score))
                .ForMember(dto => dto.ImageTitle, x => x.MapFrom(ent => ent.Image.Name))
                .ForMember(dto => dto.ImageId, x => x.MapFrom(ent => ent.Image.Id))
                .ForMember(dto => dto.Country, x => x.MapFrom(ent => ent.Section.SalonYear.Salon.Country.Name))
                .ForMember(dto => dto.OrganisationAccreditationNumber, x => x.Ignore())
                .ForMember(dto => dto.IsPrint, x => x.MapFrom(ent => ent.Section.SectionType.IsPrint))
            ;
            });
