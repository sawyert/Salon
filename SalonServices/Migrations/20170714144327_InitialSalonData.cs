...
{
    public partial class InitialSalonData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            using (var lContext = new SalonDbContext())
            {
                ...
                var lSalonYearBelghoria = new SalonYearEntity { Name = "Belghoria Photo Lovers", Salon = lSalonBelghoria, Year = 2017, ClosingDate = new DateTime(2016, 31, 12), JudgeDate = new DateTime(2017, 1, 19), NotificationDate = new DateTime(2017, 1, 31), CataloguesPostedDate = new DateTime(2017, 1, 31) };
                ...
                var lIntoTheMist = new ImageEntity() { Person = lTim, Name = "Into The Mist" };
                var lDaisy = new ImageEntity() { Person = lTim, Name = "Daisy" };
                var lRuinsByNight = new ImageEntity() { Person = lTim, Name = "Ruins By Night" };
                var lOliversCastle = new ImageEntity() { Person = lTim, Name = "Olivers Castle" };
                var lCathedralCeiling = new ImageEntity() { Person = lTim, Name = "Cathedral Ceiling" };
                var lTheDance = new ImageEntity() { Person = lTim, Name = "The Dance" };
                var lThroughTheArch = new ImageEntity() { Person = lTim, Name = "Through The Arch" };
                var lTreeGroveInTheMist = new ImageEntity() { Person = lTim, Name = "Tree Grove In The Mist" };
                var lTheWatcherInTheWaves = new ImageEntity() { Person = lTim, Name = "The Watcher In The Waves" };
                var lYoungRedKite = new ImageEntity() { Person = lTim, Name = "Young Red Kite" };
                var lGreatGreyOwl = new ImageEntity() { Person = lTim, Name = "Great Grey Owl" };
                var lAcrossTheLake = new ImageEntity() { Person = lTim, Name = "Across The Lake" };
                var lAWorldBeyond = new ImageEntity() { Person = lTim, Name = "A World Beyond" };
                var lWatchfulness = new ImageEntity() { Person = lTim, Name = "Watchfulness" };
                var lAfternoonGun = new ImageEntity() { Person = lTim, Name = "Afternoon Gun Valletta Malta" };
                var lFreshSnow = new ImageEntity() { Person = lTim, Name = "Fresh Snow South Island NZ" };
                var lLongEaredOwl = new ImageEntity() { Person = lTim, Name = "Long Eared Owl" };
                var lButtermere = new ImageEntity() { Person = lTim, Name = "Buttermere Lake District UK" };
                var lButtermereTree = new ImageEntity() { Person = lTim, Name = "Buttermere Tree" };
                var lLakeKaniere = new ImageEntity() { Person = lTim, Name = "Lake Kaniere New Zealand" };
                var lTheWatcher = new ImageEntity() { Person = lTim, Name = "The Watcher" };
                var lSpiralNine = new ImageEntity() { Person = lTim, Name = "Sprial Nine" };
                var lHedgehog = new ImageEntity() { Person = lTim, Name = "Hedgehog" };
                var lOrb = new ImageEntity() { Person = lTim, Name = "Orb" };
                var lLittleOwl = new ImageEntity() { Person = lTim, Name = "Little Owl" };
                var lFloodingInLeeds = new ImageEntity() { Person = lTim, Name = "Flooding In Leeds 2015" };
                var lBudirChurch = new ImageEntity() { Person = lTim, Name = "Budir Church Iceland" };
                var lKirkjufellSnow = new ImageEntity() { Person = lTim, Name = "Kirkjufell Snow" };
                var lBungeeJumpScream = new ImageEntity() { Person = lTim, Name = "Bungee Jump Scream" };
                var lCanadaGosling = new ImageEntity() { Person = lTim, Name = "Canada Gosling" };
                var lTowardsTheLight = new ImageEntity() { Person = lTim, Name = "Towards The Light" };
                var lBoatingInTheHail = new ImageEntity() { Person = lTim, Name = "Boating In The Hail" };

                var lLoneTree = new ImageEntity() { Person = lTim, Name = "Lone Tree" };
                var lSolitaryTree = new ImageEntity() { Person = lTim, Name = "Solitary Tree" };
                var lBridgeSuspension = new ImageEntity() { Person = lTim, Name = "Bridge Suspension" };
                var lInnerLight = new ImageEntity() { Person = lTim, Name = "Inner Light" };
                var lStarfall = new ImageEntity() { Person = lTim, Name = "Starfall" };
                var lAnotherPlaceAnotherWorld = new ImageEntity() { Person = lTim, Name = "Another Place Another World" };
                var lHarvestMouseCowParsley = new ImageEntity() { Person = lTim, Name = "Harvest Mouse on Cow Parsley" };
                var lHarvestMouseWheat = new ImageEntity() { Person = lTim, Name = "Harvest Mouse on Wheat" };
                var lWaterVole = new ImageEntity() { Person = lTim, Name = "Water Vole" };
                var lWaterVoleInPipe = new ImageEntity() { Person = lTim, Name = "Water Vole in Pipe" };
                var lZombieGirl = new ImageEntity() { Person = lTim, Name = "Zombie Girl" };
                var lLakeShore = new ImageEntity() { Person = lTim, Name = "Lake Shore" };
                var lSteppingStones = new ImageEntity() { Person = lTim, Name = "Stepping Stones" };
                var lIcelandicPeak = new ImageEntity() { Person = lTim, Name = "Icelandic Peak" };
                var lKirkjufellRock = new ImageEntity() { Person = lTim, Name = "Kirkjufell Rock" };
                var lIcelandicHorse = new ImageEntity() { Person = lTim, Name = "Icelandic Horse" };
                var lLeithReflections = new ImageEntity() { Person = lTim, Name = "Leith Reflections" };
                var lDawnInTheOutback = new ImageEntity() { Person = lTim, Name = "Dawn in the Outback" };
                var lTwelveApostlesSunset = new ImageEntity() { Person = lTim, Name = "Twelve Apostles Sunset" };
                var lPathStripes = new ImageEntity() { Person = lTim, Name = "Path Stripes" };
                var lFreshSnowIceland = new ImageEntity() { Person = lTim, Name = "Fresh Snow Iceland" };
                var lSentinel = new ImageEntity() { Person = lTim, Name = "Sentinel" };
                var lWoodlandLight = new ImageEntity() { Person = lTim, Name = "Woodland Light" };
                var lPollinationCanopy = new ImageEntity() { Person = lTim, Name = "Pollination Canopy" };
                var lTheQualityOfSilence = new ImageEntity() { Person = lTim, Name = "The Quality of Silence" };
                var lLiverpoolWheelAndDocks = new ImageEntity() { Person = lTim, Name = "Liverpool Wheel and Docks" };
                var lDreamsOfNature = new ImageEntity() { Person = lTim, Name = "Dreams Of Nature" };
                var lLivingTheMalteseDream = new ImageEntity() { Person = lTim, Name = "Living the Maltese Dream" };
                var lHarbourSailingInMalta = new ImageEntity() { Person = lTim, Name = "Harbour Sailing In Malta" };
                var l4464Bittern = new ImageEntity() { Person = lTim, Name = "4464 Bittern" };
                var lEricTreacy = new ImageEntity() { Person = lTim, Name = "Eric Treacy" };
                var lMalteseDoor = new ImageEntity() { Person = lTim, Name = "Maltese Door" };
                var lWaveWatcher = new ImageEntity() { Person = lTim, Name = "Wave Watcher" };
                var lDeepThinking = new ImageEntity() { Person = lTim, Name = "Deep Thinking" };
                var lRedKite = new ImageEntity() { Person = lTim, Name = "Red Kite" };
                var lBoltonAbbey = new ImageEntity() { Person = lTim, Name = "Bolton Abbey" };
                var lGrassIceland = new ImageEntity() { Person = lTim, Name = "Grass Iceland" };
                var lGlacierLagoonIceland = new ImageEntity() { Person = lTim, Name = "Glacier Lagoon Iceland" };
                var lZombieSelfie = new ImageEntity() { Person = lTim, Name = "Zombie Selfie" };
                var lZombieSafetyTraining = new ImageEntity() { Person = lTim, Name = "Zombie Safety Training" };
                var lZombieTraining = new ImageEntity() { Person = lTim, Name = "Zombie Training" };
                var lReflect = new ImageEntity() { Person = lTim, Name = "Reflect" };
                var lTourDeYorkshire = new ImageEntity() { Person = lTim, Name = "Tour De Yorkshire" };
                ...
                lContext.Submissions.AddRange(new List<SubmissionEntity> {
                    ...
                    new SubmissionEntity(){
                        ...
                        Entries = new List<CompetitionEntryEntity> {
                            ...
                            new CompetitionEntryEntity { Section = lSalonYearPhotoArtVisionColour, Image = lIntoTheMist, IsAwarded = true, IsAccepted = true, Score = 18, },
                    ...
                    new SubmissionEntity(){
                        ...
                        Entries = new List<CompetitionEntryEntity> {
                            ...
                            new CompetitionEntryEntity { Section = lSalonYearCarlisleColourPrint, Image = lIntoTheMist, IsAwarded = true, IsAccepted = true, Score = 15, },
                            ...
                            new CompetitionEntryEntity { Section = lSalonYearCarlisleMonoLandscapePrint, Image = lOliversCastle, IsAwarded = true, IsAccepted = true, Score = 15, },
                        },
                    },
                    new SubmissionEntity(){
                        IsJudged = true,
                    ...
                    new SubmissionEntity(){
                        ...
                        Person = lTim,
                        Entries = new List<CompetitionEntryEntity> {
                            new CompetitionEntryEntity { Section = lSalonYearLagacillyColour, Image = lIntoTheMist, IsAwarded = true, IsAccepted = true, Score = 50, },
                    ...
                    new SubmissionEntity(){
                        ...
                        Entries = new List<CompetitionEntryEntity> {
                            ...
                            new CompetitionEntryEntity { Section = lSalonYearSydneyMono, Image = lRuinsByNight, IsAwarded = true, IsAccepted = true, Score = 14, },
                            new CompetitionEntryEntity { Section = lSalonYearSydneyCreative, Image = lAWorldBeyond, IsAwarded = true, IsAccepted = true, Score = 15, },
                    ...
                    new SubmissionEntity(){
                        ...
                        Entries = new List<CompetitionEntryEntity> {
                            ...
                            new CompetitionEntryEntity { Section = lSalonYearMofNature, Image = lYoungRedKite, IsAwarded = true, IsAccepted = true, Score = 20, },
                    ...
                    new SubmissionEntity(){
                        ...
                        Person = lTim,
                        Entries = new List<CompetitionEntryEntity> {
                            new CompetitionEntryEntity { Section = lSalonYearCyprusColour, Image = lTheWatcherInTheWaves, IsAwarded = true, IsAccepted = true },
