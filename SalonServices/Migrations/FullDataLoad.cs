            ...
            using (var lContext = new SalonDbContext())
            {
                ...
                if (lContext.People.Count() == 0)
                {
                    ...
                    try
                    {
						...
						var lSalonBudva = new SalonEntity { Name = "Budva (Zeta Circuit)", Website = "http://www.photoclubmontenegro.com", Country = lCountryMontenegro };
						lContext.Salons.Add(lSalonBudva);

						var lSalonYearBudva2019 = new SalonYearEntity { Name = "Budva (Zeta Circuit)", Salon = lSalonBudva, Year = 2019, ClosingDate = new DateTime(2019, 6, 10), JudgeDate = new DateTime(2019, 7, 4), NotificationDate = new DateTime(2019, 7, 10), CataloguesPostedDate = new DateTime(2019, 9, 10), Circuit = lZetaCircuit2019 };
						...
						var lSalonKolasin = new SalonEntity { Name = "Kolasin (Zeta Circuit)", Website = "http://www.photoclubmontenegro.com", Country = lCountryMontenegro };
						lContext.Salons.Add(lSalonKolasin);

						var lSalonYearKolasin2019 = new SalonYearEntity { Name = "Kolasin (Zeta Circuit)", Salon = lSalonKolasin, Year = 2019, ClosingDate = new DateTime(2019, 6, 10), JudgeDate = new DateTime(2019, 7, 4), NotificationDate = new DateTime(2019, 7, 10), CataloguesPostedDate = new DateTime(2019, 9, 10), Circuit = lZetaCircuit2019 };
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Colour, Image = lMonsterPhotoBooth, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Colour, Image = lWartimeLettersHome, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Colour, Image = lChrysanthemumCloseUp, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019People, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019People, Image = lWaitingToTravel, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019People, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019People, Image = lJilted, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Mono, Image = lPagoda, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Mono, Image = lContemplationByStarlight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Landscapes, Image = lGrassIceland, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Landscapes, Image = lTheRedHut, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Landscapes, Image = lDerwentwaterBoatHouse, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearGeorgianDrag2019Landscapes, Image = lGrasmereRocks, IsAwarded = false, IsAccepted = false, Score=0 },
                                },
                            },
                        });
						...
						var lSalonKula = new SalonEntity { Name = "Kula", Website = "https://www.fkk.rs/main/index.php", Country = lCountrySerbia };
						lContext.Salons.Add(lSalonKula);

						var lSalonYearKula2019 = new SalonYearEntity { Name = "Kula", Salon = lSalonKula, Year = 2019, ClosingDate = new DateTime(2019, 7, 3), JudgeDate = new DateTime(2019, 7, 29), NotificationDate = new DateTime(2019, 8, 1), CataloguesPostedDate = new DateTime(2019, 10, 1), Circuit = lTourCircuit2019 };
						...
						lContext.Submissions.AddRange(new List<SubmissionEntity> {
							new SubmissionEntity(){
								...
								Person = lTim,
								Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearKula2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearKula2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Nature, Image = lBacklitTarantula, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Woman, Image = lQueenOfTheCastle, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Woman, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearKula2019Woman, Image = lByLamplight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Woman, Image = lJilted, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Colour, Image = lMonsterPhotoBooth, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Colour, Image = lChrysanthemumCloseUp, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0},                                   
									new CompetitionEntryEntity { Section = lSalonYearKula2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Mono, Image = lContemplationByStarlight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKula2019Mono, Image = lPagoda, IsAwarded = false, IsAccepted = false, Score=0},
                                },
                            },
                        });

						var lSalonBudvaTour = new SalonEntity { Name = "Budva (Tour Circuit)", Website = "https://www.fkk.rs/main/index.php", Country = lCountryMontenegro };
						lContext.Salons.Add(lSalonBudvaTour);

						var lSalonYearBudvaTour2019 = new SalonYearEntity { Name = "Budva (Tour Circuit)", Salon = lSalonBudvaTour, Year = 2019, ClosingDate = new DateTime(2019, 7, 3), JudgeDate = new DateTime(2019, 7, 29), NotificationDate = new DateTime(2019, 8, 1), CataloguesPostedDate = new DateTime(2019, 10, 1), Circuit = lTourCircuit2019 };
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Nature, Image = lBacklitTarantula, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Woman, Image = lQueenOfTheCastle, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Woman, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Woman, Image = lByLamplight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Woman, Image = lJilted, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Colour, Image = lMonsterPhotoBooth, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Colour, Image = lChrysanthemumCloseUp, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Mono, Image = lContemplationByStarlight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearBudvaTour2019Mono, Image = lPagoda, IsAwarded = false, IsAccepted = false, Score=0},
                                },
                            },
                        });

						var lSalonKolasinTour = new SalonEntity { Name = "Kolasin (Tour Circuit)", Website = "https://www.fkk.rs/main/index.php", Country = lCountryMontenegro };
						lContext.Salons.Add(lSalonKolasinTour);

						var lSalonYearKolasinTour2019 = new SalonYearEntity { Name = "Kolasin (Tour Circuit)", Salon = lSalonKolasinTour, Year = 2019, ClosingDate = new DateTime(2019, 7, 3), JudgeDate = new DateTime(2019, 7, 29), NotificationDate = new DateTime(2019, 8, 1), CataloguesPostedDate = new DateTime(2019, 10, 1), Circuit = lTourCircuit2019 };
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Nature, Image = lBacklitTarantula, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Woman, Image = lQueenOfTheCastle, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Woman, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Woman, Image = lByLamplight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Woman, Image = lJilted, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Colour, Image = lMonsterPhotoBooth, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Colour, Image = lChrysanthemumCloseUp, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Mono, Image = lContemplationByStarlight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearKolasinTour2019Mono, Image = lPagoda, IsAwarded = false, IsAccepted = false, Score=0},
                                },
                            },
                        });
						...
						var lSalonDiamanti = new SalonEntity { Name = "Diamanti Gran Prix", Website = "http://www.photocontestclub.org/en/jewels-circ/", Country = lCountryItaly };
						lContext.Salons.Add(lSalonDiamanti);

						var lSalonYearDiamanti2019 = new SalonYearEntity { Name = "Diamanti Gran Prix", Salon = lSalonDiamanti, Year = 2019, ClosingDate = new DateTime(2019, 7, 1), JudgeDate = new DateTime(2019, 7, 7), NotificationDate = new DateTime(2019, 7, 15), CataloguesPostedDate = new DateTime(2019, 10, 14), Circuit = lJewelsCircuit2019 };
						...
						var lSalonRubini = new SalonEntity { Name = "Rubini Gran Prix", Website = "http://www.photocontestclub.org/en/jewels-circ/", Country = lCountryItaly };
						lContext.Salons.Add(lSalonRubini);

						var lSalonYearRubini2019 = new SalonYearEntity { Name = "Rubini Gran Prix", Salon = lSalonDiamanti, Year = 2019, ClosingDate = new DateTime(2019, 7, 1), JudgeDate = new DateTime(2019, 7, 7), NotificationDate = new DateTime(2019, 7, 15), CataloguesPostedDate = new DateTime(2019, 10, 14), Circuit = lJewelsCircuit2019 };
						...
						var lSalonSmeraldi = new SalonEntity { Name = "Smeraldi Gran Prix", Website = "http://www.photocontestclub.org/en/jewels-circ/", Country = lCountryItaly };
						lContext.Salons.Add(lSalonSmeraldi);

						var lSalonYearSmeraldi2019 = new SalonYearEntity { Name = "Smeraldi Gran Prix", Salon = lSalonDiamanti, Year = 2019, ClosingDate = new DateTime(2019, 7, 1), JudgeDate = new DateTime(2019, 7, 7), NotificationDate = new DateTime(2019, 7, 15), CataloguesPostedDate = new DateTime(2019, 10, 14), Circuit = lJewelsCircuit2019 };
						...
						var lSalonZaffiri = new SalonEntity { Name = "Zaffiri Gran Prix", Website = "http://www.photocontestclub.org/en/jewels-circ/", Country = lCountryItaly };
						lContext.Salons.Add(lSalonZaffiri);

						var lSalonYearZaffiri2019 = new SalonYearEntity { Name = "Zaffiri Gran Prix", Salon = lSalonZaffiri, Year = 2019, ClosingDate = new DateTime(2019, 7, 1), JudgeDate = new DateTime(2019, 7, 7), NotificationDate = new DateTime(2019, 7, 15), CataloguesPostedDate = new DateTime(2019, 10, 14), Circuit = lJewelsCircuit2019 };
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019ShadowHunter, Image = lPortal, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019ShadowHunter, Image = lBagLady, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019ShadowHunter, Image = lItsAllAboutTheHair, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019ShadowHunter, Image = lShadowLight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Nature, Image = lAmazonMilkFrog, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Colour, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Colour, Image = lBetwixtRealities, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Mono, Image = lRealityDysfunction, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Mono, Image = lTheFinalGateway, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterSerbia2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0},
                                },
                            },
                        });
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019ShadowHunter, Image = lPortal, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019ShadowHunter, Image = lBagLady, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019ShadowHunter, Image = lItsAllAboutTheHair, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019ShadowHunter, Image = lShadowLight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Nature, Image = lAmazonMilkFrog, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Colour, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Colour, Image = lBetwixtRealities, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Mono, Image = lRealityDysfunction, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Mono, Image = lTheFinalGateway, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterMontenegro2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0},
                                },
                            },
                        });
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019ShadowHunter, Image = lPortal, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019ShadowHunter, Image = lBagLady, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019ShadowHunter, Image = lItsAllAboutTheHair, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019ShadowHunter, Image = lShadowLight, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Nature, Image = lAmazonMilkFrog, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Colour, Image = lComfortInAHarshWorld, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Colour, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Colour, Image = lBetwixtRealities, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Mono, Image = lRealityDysfunction, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Mono, Image = lTheFinalGateway, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearShadowHunterCroatia2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0},
                                },
                            },
                        });
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Nature, Image = lAmazonMilkFrog, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Mono, Image = lTheFinalGateway, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Mono, Image = lRealityDysfunction, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties201Colour, Image = lMonsterPhotoBooth, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties201Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties201Colour, Image = lWartimeLettersHome, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties201Colour, Image = lChrysanthemumCloseUp, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Creative, Image = lBetwixtRealities, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Creative, Image = lTimeFlies, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Creative, Image = lPartyAtTheApocalypse, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearMidlandCounties2019Creative, Image = lJourneysEnd, IsAwarded = false, IsAccepted = false, Score=0 },
                                },
                            },
                        });
                        ...
                        lContext.Submissions.AddRange(new List<SubmissionEntity> {
                            new SubmissionEntity(){
                                ...
                                Person = lTim,
                                Entries = new List<CompetitionEntryEntity> {
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Nature, Image = lPeacockTreeFrogTrio, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Nature, Image = lRoughFrilledTreeFrogOnFlower, IsAwarded = false, IsAccepted = false, Score= 0},
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Nature, Image = lCrestedGeckoTongue, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Nature, Image = lAmazonMilkFrog, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Mono, Image = lTheFinalGateway, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Mono, Image = lRealityDysfunction, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Mono, Image = lMirrorOfReminiscence, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Mono, Image = lTheWishingTree, IsAwarded = false, IsAccepted = false, Score=0},
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon201Colour, Image = lMonsterPhotoBooth, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon201Colour, Image = lIUsedToDreamIdMarryAPrince, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon201Colour, Image = lWartimeLettersHome, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon201Colour, Image = lBLuebellInWoodenVase, IsAwarded = false, IsAccepted = false, Score=0 },
									new CompetitionEntryEntity { Section = lSalonYearSouthDevon2019Creative, Image = lBetwixtRealities, IsAwarded = false, IsAccepted = false, Score=0 },
